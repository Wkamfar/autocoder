...
- CRM → world export/sync, optional DB-backed dossiers for slash commands, single operational source of truth — see [`CRM_SALES_OS_UNIFICATION.md`](./CRM_SALES_OS_UNIFICATION.md).
